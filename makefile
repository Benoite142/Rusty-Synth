...
synthObjects = ./backend/synthetiser/*.cpp ./backend/synthetiser/oscillator/*.cpp ./backend/sound_player/*.cpp ./backend/midi/*.cpp ./backend/synthetiser/envelope/*.cpp ./backend/synthetiser/operator/*.cpp ./backend/synthetiser/low_frequency_oscillator/*.cpp ./backend/wav_writer/*.cpp
